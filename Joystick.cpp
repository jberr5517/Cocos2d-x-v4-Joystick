...
bool Joystick::init()
{
	...
	touchListener->onTouchesBegan = CC_CALLBACK_2(Joystick::onTouchesBegan, this);
	touchListener->onTouchesEnded = CC_CALLBACK_2(Joystick::onTouchesEnded, this);
	touchListener->onTouchesMoved = CC_CALLBACK_2(Joystick::onTouchesMoved, this);
